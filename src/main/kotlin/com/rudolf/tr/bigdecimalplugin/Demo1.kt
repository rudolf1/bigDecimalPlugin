...
public class FactorizeAction : DumbAwareAction() {
...
private class UiDslTestDialog(project: Project?) : DialogWrapper(project, null, true, IdeModalityType.IDE, false) {
    ...
    override fun createCenterPanel(): JComponent {
        ...
        tabbedPane.addTab("Search", JScrollPane(createSearch()))
        ...
        panel = panel {
            row("Number") {
                tf = textField()
                        .align(AlignX.FILL)
                        .onChanged {
                            model.text = it.text.toCharArray().joinToString("\n")
                            panel.apply()
                        }
                        .component
            }
